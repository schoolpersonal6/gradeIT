      ...
      <div className="py-10 flex flex-col">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex px-3 gap-5">
            ...
            <Link
              href="https://github.com/orgs/GradeAI/repositories"
              target="_"
          ...
          <div className="px-3">
            <div className="px-2 py-0.5 font-semibold border bg-gray-800 w-fit rounded-xl">
              Made by Arihan, Neil, Ian, and Ibrahim
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex gap-8">
            <div className="flex flex-col flex-1">
              ...
              <div className="text-base font-normal tracking-normal flex-1 border bg-darkpaco p-4 rounded-xl  rounded-t-none">
                GradeAI can accept rubrics provided by the teacher to guide the
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="text-base font-normal tracking-normal flex-1 border bg-darkpaco p-4 rounded-xl  rounded-t-none">
                GradeAI can give feedback on each paper to explain why each
            ...
            <div className="flex flex-col flex-1">
              ...
              <div className="text-base font-normal tracking-normal flex-1 border bg-darkpaco p-4 rounded-xl  rounded-t-none">
                GradeAI can accept many formats of essays, including text, pdfs
                & other readable files, and also images. With the power of text
                recognition and OCR models, GradeAI has flexibility when it
